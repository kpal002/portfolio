...
export const navLinks = [
  ...
  { label: "Prep",     href: "#interview-prep",  id: "interview-prep" },
...
export const interviewTopics = [
  ...
  },
  {
    ...
    description: "How to design end-to-end ML systems — data pipelines, feature stores, model serving, monitoring, and failure modes.",
    tags: ["Feature Store", "Model Serving", "Drift Detection", "Retraining", "Latency"],
    diagram: ["Data", "Features", "Train", "Serve", "Monitor", "Retrain"],
  },
  {
    slug: "probability-statistics",
    title: "Probability & Statistics",
    description: "The foundations that everything in ML is built on — distributions, Bayes, hypothesis testing, and where they show up in interviews.",
  ...
  },
  {
    ...
    title: "Coding Patterns for ML",
    description: "The algorithmic patterns that come up in ML engineering interviews — from array/matrix ops to graph traversal and dynamic programming.",
    tags: ["Two Pointers", "Sliding Window", "BFS/DFS", "DP", "Matrix Ops"],
    diagram: ["Problem", "Pattern", "Data Structure", "Complexity", "Solution"],
  },
];
