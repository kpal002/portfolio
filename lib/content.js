...
export const about = {
  paragraphs: [
    ...
    "Until May 2026 I was at Beehive AI, where I built agentic RAG systems, LLM-powered evaluation frameworks, and virtual persona simulators that help product teams make sharper decisions.",
  ...
  facts: [
    ...
    { label: "Previously", value: "AI Engineer @ Beehive AI (–May 2026)" },
